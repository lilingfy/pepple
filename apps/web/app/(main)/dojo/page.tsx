...
import { MainNav } from '@/components/dojo/MainNav';
...
export default function DojoPage() {
  ...
  const { loadScenarios, selectScenario, scenarios, sessionStatus } = useDojoStore();
    ...
    <div className="fluid-bg h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="fixed bottom-[-50px] left-[-50px] opacity-10 pointer-events-none">
        <svg height="300" viewBox="0 0 200 200" width="300">
          <path d="M150 100C150 150 120 180 80 180C40 180 20 150 20 100C20 50 50 20 100 20C150 20 150 50 150 100Z" fill="#A8D8B9" />
        </svg>
      </div>
